...
import com.haui.nguyenanhtu.service.implement.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// Phân quyền chỉ người dùng mới được truy cập vào
		http.authorizeRequests().antMatchers("api/orderDetail/**", "api/cart/**").access("hasRole('ROLE_USER')");
		// Phân quyền chỉ người quản trị mới được truy cập vào
